<x-app-layout>
	...
	<section class="content">
		<!-- Default box -->
		<form class="form-horizontal" method="post" action="{{route('parameters.update', ['parameter'=>$param->id])}}" enctype="multipart/form-data">
			@csrf
			@method('PUT')
			<div class="card">
				...
				<div class="card-body">
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<select id="apiname" class="select2 form-control form-control-sm" style="width:100%" name="apiname" data-placeholder="API Name">
								<option></option>
								@if($apis->count() > 0)
									@foreach($apis as $api)
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<select id="paramstype" class="select2 form-control form-control-sm" style="width:100%" name="paramstype" data-placeholder="Params Type">
								<option></option>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" required name="key" value="{{old('key', $param->params_key)}}" class="form-control form-control-sm" id="key" placeholder="Key">
						</div>
					</div>
					<div class="form-group row">
						<label for="value" class="col-sm-2 col-form-label">Value</label>
						<div class="col-sm-10">
							<input type="text" name="value" value="{{old('value', $param->params_value)}}" class="form-control form-control-sm"" id="value" placeholder="Value">
						</div>
					</div>
					<div class="form-group row">
						<label for="isactive" class="col-sm-2 col-form-label">Active?</label>
						<div class="custom-control custom-switch col-sm-10">
							@if(old('isactive', $param->isactive) == 1)
